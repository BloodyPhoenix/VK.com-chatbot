...
# Это задание на ручное вычисление - что бы потом понять как работают циклы и насколько с ними прощежить.

# Но есди я знаю циклы, я уже понимаю, как они работают, и насколько с ними проще жить...
# Вообще странное задание. Учитывая, что есть пример, как решать, оно превращается в сплошую копипасту
# с незначительными изменениями в переменных. И чему оно должно научить?

table_code = goods['Стол']
table_item1 = store[lamp_code][0]
