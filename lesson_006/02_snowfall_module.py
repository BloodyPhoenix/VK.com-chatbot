...
# TODO Если посмотреть внимательно есть баги в алгоритме! Снежинки не долетая до конца удаляются
# TODO Наблюдаю что только что созданные снежинки которые в полете тоже удаляются!
