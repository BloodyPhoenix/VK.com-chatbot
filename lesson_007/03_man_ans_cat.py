...
for day in range(1, 366):
    print(f'================ день {day} ==================')
    # TODO нужно обратно добавить действие для человека, зачем удалили ?
    ...
    for cat in cats:
        if not cat.check_if_alive():
            # TODO в таком случаем break выйдет из цикла который он найдет первым на своем пути выше,
            # TODO из главного цикла мы таким способом не выйдем, нужно подумать как это сделать.
            break
