...
# Все верно на 1 ошибся
# Результат Елены по раундам: 8 + 5 + 20 + 6 + 15 + 14+ 8 + 0 + 8 + 20 = 105
...
# TODO убрать запятые в выводе результата
#  Елена       3532X332/3/62--62X , 105 -> Елена       3532X332/3/62--62X  105

# TODO и предлагаю вам сделать вторую часть

# TODO сейчас считается все верно
