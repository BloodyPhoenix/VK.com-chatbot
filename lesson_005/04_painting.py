...
# TODO в этом модуле нужно только вызывать функции!
# TODO объявлять их нужно в отдельных модулях в пакете

# TODO весь код функций объявить в модулях, тут только их вызов!

def static_painting ():

    # TODO импорты делаются в начале модуля!
