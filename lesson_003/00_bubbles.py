...
def bubble (point, step, color):
    radius = 50
    # TODO этот цикла у нас уже есть в функции bubble его тут можно убрать
    for _ in range(3):
...
for x in range (100, 1001, 100):
     ...
     # TODO x у нас получается в заголовки цикла for это уже лишнее
     x += 100
...
for y in range (400, 550, 50):
    for x in range (100, 1001, 100):
        ...
        # TODO аналогично цикл лишний пишем сразу вызов функции
        for _ in range(5):
...
for _ in range(100):
    # TODO используем sd.random_point()
    y = rd(0, 599)
    x = rd (0, 1199)
    point = sd.get_point(x, y)
    # TODO используем sd.random_color()
    color = (rd(0, 225), rd (0, 225), rd (0, 225))
    # TODO этот цикл убрать!
    for _ in range (5):
