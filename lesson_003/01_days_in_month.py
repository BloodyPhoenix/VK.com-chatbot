...
# TODO значение этой функции у нас при положительном результате будем True
# TODO условие иф пропустит нас и так без дополнительной проверки на True
# TODO о чем вам подсказываем пайчарм
